...
function pageCover(qLabel, year) {
  ...
  <div class="mr-page cover" style="isolation:isolate">
    ...
    <div class="cover-title" style="left:49.9%;top:35.6%">
      <div class="period" contenteditable="true" data-p="_coverPeriod"
           style="font-size:22px;line-height:1.25;margin-bottom:1px">${qLabel} ${year}</div>
      <h1 style="font-size:29px;line-height:1.1;letter-spacing:-.5px">OFFICE MARKET<br>REPORT</h1>
    </div>
  </div>`;
}
...
function pageAppendix(model, year, qKey) {
  ...
  return `
  <div class="mr-page" style="isolation:isolate">
