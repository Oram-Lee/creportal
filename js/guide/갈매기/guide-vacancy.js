                    ...
                    ${group.items.map(v => {
                        ...
                        return `
                            <div class="external-vacancy-item ${isSelected ? 'selected' : ''}" 
                                ...
                                <div class="vacancy-area">${formatPrice(v.exclusiveArea || v.area || '-')}/${formatPrice(v.rentArea || v.area || '-')}평</div>
    ...
    return selectedVacancies.map(v => `
        <div class="cart-item">
            <div class="cart-item-info">
                ...
                <span class="cart-area">${formatPrice(v.exclusiveArea || v.area || '-')}/${formatPrice(v.rentArea || v.area || '-')}평</span>
