        ...
        <div class="fullpreview-building">
            <div class="fullpreview-building-header">
                ...
                <div class="fullpreview-region" style="text-align:right; line-height:1.5;">
                    ...
                    <span>Leasing Information (${guideType === 'retail' ? `Retail · ${region}` : region})</span>
                </div>
            </div>
                ...
                <div class="fullpreview-col fullpreview-col-right">
                    <div class="preview-section vacancy-section">
                        <div class="section-title-row">
                            ...
                            <span class="section-unit">${vacCols.unitNote}</span>
                        </div>
                        <div class="section-content">
                            <table class="vacancy-table">
                                <thead>
                                    <tr>
                                        ${vacCols.editor.map(h => `<th>${h}</th>`).join('')}
                                    </tr>
                                </thead>
                                <tbody>
                                    ${vacancies.length > 0 ? vacancies.slice(0, 5).map(v => guideType === 'retail' ? `
                                        <tr>
                                    ...
                                    `).join('') : `<tr><td colspan="${vacCols.editor.length}" class="empty-cell">공실 없음</td></tr>`}
                                </tbody>
                                ${vacancies.length > 0 ? `
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="${vacCols.editor.length - 3}">-</td>
                                    </tr>
                                </tfoot>
                                ` : ''}
                            </table>
                    ...
                    <div class="preview-section rent-section">
                        <div class="section-title-row">
                            <span>RENT</span>
                            <span class="section-unit">${guideType === 'retail' ? '(단위:원/월 총액)' : '(단위:원/임대평)'}</span>
                        </div>
                        <div class="section-content">
                            <table class="rent-table">
                                ...
                                <tbody>
                                    ...
                                    </tr>`).join('') : `<tr><td colspan="${span}" class="empty-cell">-</td></tr>`}
                                </tbody>`;
                                })() : `
                                <thead>
                                    <tr>
                            ...
                            ${guideType === 'retail' && item.retailRentNote ? `<div class="rent-footnote" style="font-size:8px; color:#64748b; margin-top:3px;">${item.retailRentNote}</div>` : ''}
                        </div>
                    </div>
